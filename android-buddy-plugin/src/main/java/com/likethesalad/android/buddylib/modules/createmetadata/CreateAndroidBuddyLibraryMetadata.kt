...
@Inject constructor(args: CreateMetadataTaskArgs, private val extension: AndroidBuddyLibExtension) : DefaultTask() {
    ...
    @get:Input
    val id: Property<String> by lazy { extension.id }

    @get:Input
    val inputClassNames: SetProperty<String> by lazy { extension.exposedTransformationNames }
